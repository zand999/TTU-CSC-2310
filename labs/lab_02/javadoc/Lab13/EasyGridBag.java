...
public class EasyGridBag extends GridBagLayout
{
    ...
    * <b>Preconditions</b>:  numRows and numColumns specify the dimension of the desired grid (not all cells need to be filled).
    *                 The values are expected to be integers greater than 0.<br>
    * <b>Postconditions</b>: If the Preconditions are met, the desired grid is created and ready to accept components.
    */
    ...
    * <b>Preconditions</b>:  row and column specify the placement location (must be valid values).<br>
    *                 comp is the component to insert at that location (not null).<br>
    *                 cont is the container using EasyGridBag Layout (not null).<br>
    * <b>Postconditions</b>: If the Preconditions are met, the component is inserted at the specified location in the layout using center alignment.<br>
    ...
    * <b>Postconditions</b>: If the Preconditions are met, the component is inserted at the specified location in the layout, using the specified alignment.<br>
    *                 Otherwise, no action is taken.
    */
    ...
    * <b>Preconditions</b>:  row indicates the desired row (must be a valid row), and weight sets desired weight of that row.<br>
    *                 The default weight is that all rows are given weight 1.0.<br>
    * <b>Postconditions</b>: If the Preconditions are met, the weight of the row is set as indicated.
    */
    ...
    * <b>Preconditions</b>:  column indicates the desired column (must be a valid column), and weight sets desired weight of that column.<br>
    *                 The default weight is that all columns are given weight 1.0.<br>
    * <b>Postconditions</b>: If the Preconditions are met, the weight of the column is set as indicated.
    */
